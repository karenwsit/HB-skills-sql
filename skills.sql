...
-- The difference between left join is a left join includes all of the Models + whatever Brands has in common w/ the left join.
-- An inner join is only the common content Models & Brands has
